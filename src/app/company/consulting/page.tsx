  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-grow bg-background">
        ...
        <section className="section-padding bg-primary text-primary-foreground text-center">
          <div className="container-max">
            ...
            <p className="text-lg md:text-xl text-primary-foreground/80 max-w-2xl mx-auto animate-fade-in-up animation-delay-200">
              Partner with Innovatech to navigate complexity, unlock opportunities, and achieve strategic excellence.
            </p>
          </div>
        </section>
        ...
        {/* Why Partner with Innovatech Consulting? */}
        <section className="section-padding">
          <div className="container-max">
            <h2 className="text-3xl md:text-4xl font-bold text-primary text-center mb-12 animate-fade-in-up">
              Why Partner with Innovatech Consulting?
          ...
          <div className="container-max grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="animate-fade-in-right animation-delay-100">
              ...
              <blockquote className="border-l-4 border-primary pl-4 italic text-muted-foreground mb-4">
                "Innovatech's consulting team provided invaluable insights that transformed our approach to AI. Their strategic guidance led to a 30% increase in operational efficiency within six months."
              </blockquote>
