...
const faqItems = [
  {
    question: "What services does Avyukta offer?",
    answer: "Avyukta offers a wide range of technology solutions including custom software development, AI and machine learning services, web and mobile application development, cloud consulting, and IT strategy services. We tailor our solutions to meet the unique needs of each client.",
  },
  {
  ...
  {
    question: "What industries does Avyukta specialize in?",
    answer: "While we have experience across various sectors, Avyukta has particular expertise in FinTech, Healthcare, Retail, and SaaS. Our adaptable approach allows us to deliver impactful solutions for businesses of all sizes in diverse industries.",
  },
  {
        ...
        <section className="section-padding bg-primary text-primary-foreground text-center">
          <div className="container-max">
            ...
            <p className="text-lg md:text-xl text-primary-foreground/80 max-w-2xl mx-auto animate-fade-in-up animation-delay-200">
              Find answers to common questions about Avyukta, our services, and products.
            </p>
          </div>
        </section>
