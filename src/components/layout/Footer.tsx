          ...
          <div>
           ...
           <div>
                ...
                <div className="flex space-x-4">
                    ...
                    <Link href="https://www.linkedin.com/company/avyukta-intellicall1/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="text-muted-foreground hover:text-primary transition-colors"><Linkedin size={20} /></Link>
